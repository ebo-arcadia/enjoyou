...
import { searchMovie, fetchMovies, loadingMovies } from '../../actions/MovieActions';
...
export default connect(mapStateToProps, {searchMovie, fetchMovies, loadingMovies})(SearchMovieForm);
